...
-   An 8 bit field that indicates how many [router](/references/2020/the-bits-and-bytes-of-computer-networking/router.md) hops a datagram can traverse before it’s thrown away
