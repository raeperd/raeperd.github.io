...
# Intro
The principles for clean code are usually abstract and not easy. As the famous [Clean Code](/references/2020/clean-code.md) claims, it is harder than you think to come up with a good name and express a function with a few lines. Because it is difficult, many developers create simple names and long function codes without thinking for a long time.
